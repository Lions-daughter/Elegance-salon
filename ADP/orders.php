        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              ...
              <a class="sidebar-link" href="ordersform.php" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
                <span class="hide-menu">order form</span>
              </a>
            </li>
          </ul>
       ...
       <table class="table table-striped  table-light">
        ...
        <?php
          ...
          <tr>
            ...
            <td> <a href='oedit.php?edit=<?php echo $row["order_no"];?>' class="btn btn-danger">Edit</a></td>
            <td> <a href='orderdelete.php?delete=<?php echo $row["order_no"];?>' class="btn btn-danger"> Delete</a></td>
...
?>
      ...
      <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label"><h5>ADD USERS</h5></label>
                   <a href="ordersform.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
