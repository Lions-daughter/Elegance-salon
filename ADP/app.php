      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            </li>   <i class="ti ti-file-description"></i>
                </span>
                <span class="hide-menu">feedback form </span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="appointmentform.php" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
...
?>
      ...
      <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label"><h5>ADD clients</h5></label>
                      <a href="app.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
