       ...
       <table class="table table-striped  table-light">
        ...
        <?php
          ...
          <tr>
            ...
            <td> <a href='uedit.php?edit=<?php echo $row["user_id"];?>' class="btn btn-danger">Edit</a></td>
            <td> <a href='usersdelete.php?delete=<?php echo $row["user_id"];?>' class="btn btn-danger"> Delete</a></td>
...
?>
      ...
      <div class="mb-3">
                   ...
                   <a href="usersform.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
