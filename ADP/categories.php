       ...
       <thead class="table-danger">
        ...
        <tbody >
          ...
          <tr>
            ...
            <td> <a href='cedit.php?edit=<?php echo $row["cat_id"];?>' class="btn btn-danger">Edit</a></td>
            <td> <a href='categoriesdelete.php?deletebtn=<?php echo $row["cat_id"];?>' class="btn btn-danger"> Delete</a></td>
...
?>
      ...
      <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label"><h5>ADD CATEGORIES</h5></label>
                      <a href="categoriesform.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
