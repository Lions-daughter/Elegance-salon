       ...
       <thead class="table-danger">
        ...
        <?php
          ...
          <tr>
            ...
            <td><?php echo $row['f_sugg']; ?></td>
            <td><?php echo $row['service']; ?></td>
            <td> <a href='fedit.php?edit=<?php echo $row["id"];?>' class="btn btn-danger">Edit</a></td>
            <td> <a href='feedelete.php?delete=<?php echo $row["id"];?>' class="btn btn-danger"> Delete</a></td>
...
?>
      ...
      <div class="mb-3">
                      ...
                      <a href="feedbackform.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
