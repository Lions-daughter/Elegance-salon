          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="usersdisplay.php" aria-expanded="false">
                ...
                <span class="hide-menu" name="sname">users</span>
              </a>
            </li>
            <li class="sidebar-item">
       ...
       <thead class="table-danger">
        ...
        <?php
          ...
          <td><?php echo $row['product_id']; ?></td>
            ...
            <td><?php echo $row['product_cat_id']; ?></td>
            <td> <a href='pedit.php?edit=<?php echo $row["product_id"];?>' class="btn btn-danger">Edit</a></td>
            <td> <a href='productsdelete.php?delete=<?php echo $row["product_id"];?>' class="btn btn-danger"> Delete</a></td>
          </tr>
...
?>
      ...
      <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label"><h5>ADD PRODUCTS</h5></label>
                      <a href="productsform.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
