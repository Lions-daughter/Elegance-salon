       ...
       <thead class="table-danger">
        ...
        <?php
          ...
          <tr>
            ...
            <td><?php echo $row['staff_role_id']; ?></td>
            <td><?php echo $row['shift']; ?></td>
            <td> <a href='staffedit.php?edit=<?php echo $row["staff_id"];?>' class="btn btn-danger">Edit</a></td>
            <td> <a href='staffdelete.php?delete=<?php echo $row["staff_id"];?>' class="btn btn-danger"> Delete</a></td>
...
?>
      ...
      <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label"><h5>ADD NEW STAFF</h5></label>
                      <a href="staffform.php"><button type="submit" class="btn btn-danger">ADD</button></a>
                    </div>
    </div>
  </div>
